...
template<> CAVRNUSCONNECTOR_API UScriptStruct* StaticStruct<FCavrnusInputDevice>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_CavrnusConnector_Source_CavrnusConnector_Public_Types_CavrnusInputDevice_h_Statics::ScriptStructInfo[] = {
		{ FCavrnusInputDevice::StaticStruct, Z_Construct_UScriptStruct_FCavrnusInputDevice_Statics::NewStructOps, TEXT("CavrnusInputDevice"), &Z_Registration_Info_UScriptStruct_CavrnusInputDevice, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCavrnusInputDevice), 3456083344U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_CavrnusConnector_Source_CavrnusConnector_Public_Types_CavrnusInputDevice_h_3096714432(TEXT("/Script/CavrnusConnector"),
		nullptr, 0,
