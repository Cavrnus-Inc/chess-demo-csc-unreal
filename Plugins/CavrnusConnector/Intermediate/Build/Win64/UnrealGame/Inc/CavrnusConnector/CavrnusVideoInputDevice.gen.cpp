...
template<> CAVRNUSCONNECTOR_API UScriptStruct* StaticStruct<FCavrnusVideoInputDevice>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_CavrnusConnector_Source_CavrnusConnector_Public_Types_CavrnusVideoInputDevice_h_Statics::ScriptStructInfo[] = {
		{ FCavrnusVideoInputDevice::StaticStruct, Z_Construct_UScriptStruct_FCavrnusVideoInputDevice_Statics::NewStructOps, TEXT("CavrnusVideoInputDevice"), &Z_Registration_Info_UScriptStruct_CavrnusVideoInputDevice, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCavrnusVideoInputDevice), 107967232U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_CavrnusConnector_Source_CavrnusConnector_Public_Types_CavrnusVideoInputDevice_h_3590510446(TEXT("/Script/CavrnusConnector"),
		nullptr, 0,
